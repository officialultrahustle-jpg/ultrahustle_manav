// TeamContractListing.jsx
import React, { useMemo, useState } from "react";
import UserNavbar from "../components/UserNavbar";
import Sidebar from "../components/Sidebar";
import "./TeamContractListing.css";
import '../Darkuser.css';

export default function TeamContractListing({ theme = "light", setTheme }) {


    const contractId = useMemo(() => "TEAM-888999", []);
    // ✅ Sidebar state
    ...
    const activity = useMemo(
        () => [
            { ts: "2025-12-10 10:12", actor: "Client @acme", action: "Created contract", details: "Title: Team Project Contract" },
            { ts: "2025-12-10 11:05", actor: "Team Owner @alpha", action: "Edited milestones", details: "Added Milestone 2 (₹50,000)" },
        ],
        []
    );
                    ...
                    <div className="relative z-10 overflow-y-auto h-[calc(100vh-85px)]">
                        <main className="cnc-main">
                            <div className="cnc-wrap">
                                <h1 className="cnc-title">Create New Team Contract</h1>
                                ...
                                <div className="cnc-card cnc-card--mt">
                                    ...
                                    <div className="cnc-twoCards">
                                        ...
                                        <div className="cnc-subcard">
                                            <div className="cnc-subTop">
                                                <div className="cnc-subTitle">Service Provider (Team)</div>
                                            </div>
                                            <div className="cnc-subGrid">
                                                <div className="cnc-field">
                                                    <label className="cnc-label">Team Owner username</label>
                                                    <input
                                                        className="cnc-input"
                                                ...
                                                <div className="cnc-field">
                                                    <label className="cnc-label">Team Full name</label>
                                                    <input
                                                        className="cnc-input"
                                                        placeholder="Full name"
                                ...
                                <div className="cnc-card cnc-card--mt">
                                    ...
                                    <div className="cnc-slaGrid">
                                        ...
                                        <div className="cnc-field">
                                            <label className="cnc-label">Team responsibilities</label>
                                            <input
                                                className="cnc-input"
                                ...
                                <div className="cnc-confirmRow cnc-card--mt">
                                    ...
                                    <div className="cnc-confirmCard">
                                        <div className="cnc-confirmTitle">Final Confirmation (Team Owner)</div>
                                        <div className="cnc-field">
                                            <label className="cnc-label">Full Name</label>
                                            <input
                                                className="cnc-input"
