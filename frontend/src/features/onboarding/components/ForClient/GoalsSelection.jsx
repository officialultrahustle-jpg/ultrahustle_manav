              ...
              {goals.map((goal) => {
                ...
                return (
                  <div
                    ...
                    onClick={() => toggleGoal(goal.id)}
                    className={`
                      flex items-center gap-2 min-[950px]:gap-3 px-3 py-2.5 min-[950px]:px-4 min-[950px]:py-3 rounded-[10px] cursor-pointer border-2 backdrop-blur-sm transition-all duration-300
                      ${isSelected
