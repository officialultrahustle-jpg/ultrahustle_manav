                  ...
                  {["Yes", "No", "Maybe Later"].map((option) => {
                    ...
                    return (
                      <button
                        ...
                        className={[
                          "h-10 min-[701px]:h-12 px-4 sm:px-6 min-[701px]:px-8 rounded-2xl border font-medium transition-all text-[13px] sm:text-sm min-[701px]:text-base shadow-[0_1px_2px_rgba(0,0,0,0.05)] hover:brightness-95",
                          active
                            ? "bg-[#CEFF1B] border-black/40 text-black"
                            : "bg-gradient-to-b from-white to-[#F4F4F4] border-black/20 text-black/50",
                        ].join(" ")}
                      >
                        {option}
                      </button>
              ...
              <div className="flex gap-4">
                {["Yes", "No", "Maybe Later"].map((option) => (
                  <button
                    ...
                    className={[
                      "h-12 px-9 rounded-[14px] border font-medium transition-all text-sm shadow-[0_1px_2px_rgba(0,0,0,0.05)] hover:brightness-95",
