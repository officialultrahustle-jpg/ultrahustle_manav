                                ...
                                <>
                                    ...
                                    <div className="ms-lower">
                                        ...
                                        <div className="ms-side">
                                            ...
                                            <div className="ms-panel ms-panel-revision ms-panel-cancel">
                                                <div className="ms-panelTitle">
                                                    Cancellation Requested
                                                </div>
                                                <div className="ms-panelSub ms-panel-cancel-sub">
                                                    The client has requested to
                                                    cancel this project.
                                                </div>

                                                <div className="ms-timer ms-cancel-timer">
                                                    <div className="ms-timeBox ms-cancel-timeBox">
                                                ...
                                                <div className="ms-panelTitle small">
                                                    Description
                                                </div>
                                                <div className="ms-descText ms-cancel-desc">
                                                    This request is now awaiting
                                                    your response. You can
                                                    approve or decline the
                                                    cancellation within the time
                                                    window shown above.
                                                </div>

                                                <div className="ms-cancel-reasonBox">
                                                    <div className="ms-cancel-reasonLabel">
                                                        Reason
                                                    </div>
                                                    <div className="ms-cancel-reasonText">
                                                        The client is not
                                                ...
                                                <div className="ms-cancel-note">
                                                    <span className="ms-cancel-noteLead">
                                                        If you accept,
                                                    </span>{" "}
                                                    the milestone will be
                                                    cancelled and funds will be
                                                ...
                                                <div className="ms-cancel-actions">
                                                    <button
                                                        className="ms-actionBtn lime ms-cancel-actionBtn"
                                                        type="button"
                                                    >
                                                        Decline
                                                    </button>
                                                    <button
                                                        className="ms-actionBtn ms-cancel-actionBtn"
                                                        type="button"
                                                    >
                                                        Accept
                                                    </button>
